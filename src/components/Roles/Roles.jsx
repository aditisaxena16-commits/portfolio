...
<div className="relative border-l border-gray-300 pl-10">
     <div className="mb-6">
      ...
      <h3 className="font-bold text-[#ded7d7]">Frontend Developer</h3> <p class="text-[#ded7d7]">Built responsive UI of a live European Website and collaborated with designers</p> </div>
       <div className="mb-6"> 
        <span className="absolute -left-3 top-25 md:top-18 w-6 h-6 bg-orange-600 rounded-full"></span>
      ...
      <div className="mb-6"> 
        <span className="absolute -left-3 top-50 md:top-36 w-6 h-6 bg-orange-600 rounded-full"></span>
       ...
       <div className="mb-6"> 
        <span className="absolute -left-3 top-85 md:top-55 w-6 h-6 bg-orange-600 rounded-full"></span>
       ...
       <div className="mb-6"> 
        <span className="absolute -left-3 top-110 md:top-72 w-6 h-6 bg-orange-600 rounded-full"></span>
